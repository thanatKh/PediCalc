...
// Handles: (1) PDF preview — raw PDF bytes at /pdf-preview/{filename},
...
// ── PDF registration ─────────────────────────────────────────────────────────
// Raw PDF bytes stored at /pdf-preview/{filename}.
// SW intercepts that URL and serves the bytes with Content-Type: application/pdf.
// The browser sees a real PDF URL with the clinical filename → native viewer opens,
// Ctrl+S / share sheet saves as TPN-xxxx.pdf with correct name and type.
...
self.addEventListener('fetch', (e) => {
  ...
  // 1. PDF — intercept ALL /pdf-preview/ requests including navigate + Range
